...
function menu:init(args)
	...
	local placesmenu = {
		...
		{ "Music",       env.fm .. " Музыка",     micon("folder-music")     },
		{ "Pictures",    env.fm .. " Изображения",micon("folder-pictures")  },
		{ "Videos",      env.fm .. " Видео",      micon("folder-videos")    },
		separator,
		{ "Media",       env.fm .. " /mnt", micon("folder-bookmarks") },
	...
	self.mainmenu = redflat.menu({ theme = theme,
		items = {
			...
			separator,
			{ "PaleMoon","palemoon", micon("palemoon") },
			{ "Krusader","krusader", micon("folder") },
			{ "PyCharm", "pycharm-community",  micon("PyCharm") },
			separator,
